...
public class MongoDBConnectionHandler {
     ...
     * @return
     */
    public boolean update(Comment pComment) throws UIMAException {
    ...
    public Document insertSpeech(Speech pSpeech) throws UIMAException {
        ...
        if(rDocument==null){
            ...
            Document insertObject = MongoHelper.toMongoDocument(pSpeech);
    ...
    public Document insertComment(Comment pComment) throws UIMAException {
